...
<template>
  <div class="login-container">
    <div class="box-item desc">
      <div class="welcome">
        <img class="gduf-logo" :src="gdufLogo" alt="广东金融学院" />
        <p class="system-title">成绩管理系统</p>
        <p class="sub-welcome">广东金融学院 · 互联网学院学生会学习部</p>
      </div>
      <div class="welcome-img-box">
        <img class="welcome-img" :src="hlwyImg" />
      </div>
    </div>
...
<script setup lang="ts">
  ...
  import gdufLogo from '/@/assets/images/gduf/logo.png';
  import hlwyImg from '/@/assets/images/gduf/hlwy.jpg';
